...
local function LoadDefaultSettings(addon)
	...
	ADDON:AddDefaultSettings('combatEvents', 'swaps', {reportChannel = 'say', isEnabled = true})
  ...
  -- Populate settings
	...
	ADDON:AddOption('Combat Events', 'Say chat swaps always', 'swaps', AstralAnalytics.options.combatEvents.swaps.isEnabled)
