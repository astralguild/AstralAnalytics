...
local function LoadDefaultSettings(addon)
	...
	ADDON:AddDefaultSettings('combatEvents', 'swaps', {reportChannel = 'say', sayChat = true, officerChat = false})
  ...
  -- Populate settings
	...
	ADDON:AddOption('Combat Events', 'Say chat swaps always', 'swapsSayChat', AstralAnalytics.options.combatEvents.swaps.sayChat)
	ADDON:AddOption('Combat Events', 'Officer chat swaps always', 'swapsOfficerChat', AstralAnalytics.options.combatEvents.swaps.officerChat)
