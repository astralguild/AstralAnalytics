...
local function LoadDefaultSettings(addon)
	...
	ADDON:AddDefaultSettings('combatEvents', 'special', {reportChannel = 'say', sayChat = true, officerChat = false})
  ...
  -- Populate settings
	...
	ADDON:AddOption('General', 'Announce to Channel', 'announceChannel', AstralAnalytics.options.general.announceChannel)
	...
	ADDON:AddOption('Combat Events', 'Say chat swaps always', 'specialSay', AstralAnalytics.options.combatEvents.special.sayChat)
	ADDON:AddOption('Combat Events', 'Officer chat swaps always', 'specialOfficer', AstralAnalytics.options.combatEvents.special.officerChat)
