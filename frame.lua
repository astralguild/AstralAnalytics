...
function Row:CreateRow(parent, index)
	...
	self.name = self:CreateFontString(nil, 'OVERLAY', 'AstralFontNormal_AA')
...
addSpellInput:SetFontObject(AstralFontNormal_AA)
...
removeSpellInput:SetFontObject(AstralFontNormal_AA)
...
scaleSetter:SetFontObject(AstralFontNormal_AA)
